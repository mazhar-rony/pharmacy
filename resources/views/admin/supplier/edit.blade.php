            ...
            <div class="card">
                ...
                <div class="body">
                    <form action="{{ route('admin.supplier.update', $supplier->id) }}" method="POST">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line {{ $errors->has('name') ? 'focused error' : '' }}">
                                <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" 
                                    name="name" value="{{ !empty(old('name')) ? old('name') : $supplier->name }}">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line {{ $errors->has('organization') ? 'focused error' : '' }}">
                                <input type="text" id="organization" class="form-control @error('organization') is-invalid @enderror" 
                                    name="organization" value="{{ !empty(old('organization')) ? old('organization') : $supplier->organization }}">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line {{ $errors->has('phone') ? 'focused error' : '' }}">
                                <input type="text" id="phone" class="form-control @error('phone') is-invalid @enderror" 
                                    name="phone" value="{{ !empty(old('phone')) ? old('phone') : $supplier->phone }}">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line {{ $errors->has('address') ? 'focused error' : '' }}">
                                <textarea id="address" class="form-control @error('address') is-invalid @enderror" 
                                    rows="2" name="address">{{ !empty(old('address')) ? old('address') : $supplier->address }}</textarea>
                        ...
                        <a type="button" class="btn btn-danger m-t-15 waves-effect" href="{{ route('admin.supplier.index') }}">BACK</a>
