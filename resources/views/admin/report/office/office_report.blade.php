    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div>
                    <form action="{{ route('admin.report.showOfficeExpenses') }}" method="POST">
                    @csrf
                            ...
                            <tbody>
                                @foreach ($officeExpenses as $key=>$officeExpense)
                                    <tr>                          
                                        ...
                                        <td>{{ Carbon\Carbon::parse($officeExpense->date)->format('l d F Y') }}</td>  
                                        <td>{{ number_format(round($officeExpense->expense, 2), 2) }}</td>                                      
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
