    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div>
                    <form action="{{ route('admin.report.showReturn') }}" method="POST">
                    @csrf
    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box bg-purple">
                ...
                <div class="content">
                    <div class="text">TOTAL RETURNED PRODUCTS</div>
                    <div class="number count-to" data-from="0" data-to="{{ $total_return_products }}" data-speed="1000" data-fresh-interval="20"></div>
                </div>
            </div>
        </div>
    </div>
