    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div>
                    <form action="{{ route('admin.report.cash') }}" method="POST">
                    @csrf
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
            <div class="info-box bg-teal hover-expand-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{ number_format(round($total_income, 2), 2) }}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
            <div class="info-box bg-pink hover-expand-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{ number_format(round($total_expense, 2), 2) }}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
            <div class="info-box bg-purple hover-expand-effect">
                ...
                <div class="content">
                    ...
                    <div class="number">{{ number_format(round($cashInStore, 2), 2) }}</div>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                @foreach ($cashes as  $key=>$cash)
                                    <tr>
                                        ...
                                        <td>{{ $cash->income != 0 ? number_format(round($cash->income, 2), 2) : '' }}</td>                   
                                        <td>{{ $cash->expense != 0 ? number_format(round($cash->expense, 2), 2) : '' }}</td>                                        
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
