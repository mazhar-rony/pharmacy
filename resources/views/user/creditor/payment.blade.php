        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="{{ route('user.creditor.payToCreditor', $creditor->id) }}" method="POST" 
                            ...
                            <div class="row clearfix" style="margin-top: 30px;">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="due_remain" name="due_remain" value="{{ round($creditor->due, 2) }}" class="form-control" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="due" name="due" value="{{ round($creditor->due, 2) }}" class="form-control" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-offset-5 col-md-offset-5 col-sm-offset-4 col-xs-offset-4">
                                    <a type="button" class="btn btn-danger m-t-15 waves-effect" href="{{ route('user.creditor.index') }}">BACK</a>
...
<!-- Bootstrap Material Datetime Picker Plugin Js -->
    ...
    function dueRemain(){
        ...
        //php variable $cash declared in top of due_remain
