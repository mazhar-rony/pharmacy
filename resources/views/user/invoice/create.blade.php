    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <form action="{{ route('user.invoice.store') }}" method="POST" id="invForm">
                @csrf
                <div class="body">                        
                    <div class="row clearfix">
                ...
                <div class="body">
                    ...
                    @csrf --}}
                        ...
                        <a type="button" class="btn btn-danger m-t-15 waves-effect" href="{{ route('user.invoice.index') }}">BACK</a>
...
<!-- Dependency Invoice No with Selected Date -->
    <script>    
            ...
            $(document).on('change', '#invoice_date', function(){
                ...
                if(invoice_date){                   
                    $.ajax({
                        url: "{{route('dependency.getInvoice')}}",
                        type: "GET",
